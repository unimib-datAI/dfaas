...
and on [faasd v0.14.4](https://github.com/openfaas/faasd) (a lightweight version of OpenFaaS) to implement the FaaS platform.
...
```shell
./setup-environment v20.10.14 v2.5.0 0.5.0 k5.4
```
