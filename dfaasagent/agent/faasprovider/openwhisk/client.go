...
// owAnnotation represents a single OpenWhisk action annotation. Value is
// json.RawMessage because the OpenWhisk API uses arbitrary JSON for annotation
// values (objects, booleans, numbers, or strings).
